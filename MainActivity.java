...
public class MainActivity {		
	...
	public static void main(String[] args) {
		...
		System.out.println("[GUI (awt/swing) - 주문 관리 프로그램 만들기 (JComboBox , JTable , JScrollPane)]");
	...
	public static void setJComboBoxStyle(JComboBox combo) {							
		...
		combo.setForeground(Color.BLACK); //TODO 텍스트 색상 정의
	...
	public static void setJButtonStyle(JButton btn) {
		...
		btn.setForeground(Color.BLACK); //TODO 텍스트 색상 정의
